...
const DashboardPage = () => {
  ...
  let ListProperty = async (e) => {
    ...
    let response = await fetch(
      "https://web-production-e7a3.up.railway.app/listings-create/",
      {
        method: "POST",
  ...
  const getListedProperties = async () => {
    const response = await fetch(
      `https://web-production-e7a3.up.railway.app/my-listings/${user.user.pk}`,
  ...
  const getBookedProperties = async () => {
    const response = await fetch(
      `https://web-production-e7a3.up.railway.app/my-bookings/${user.user.pk}`,
  ...
  const createWithdrawal = async () => {
    const response = await fetch(
      `https://web-production-e7a3.up.railway.app/withdrawal/`,
      {
        method: "POST",
  ...
  const getWithdrawals = async () => {
    const response = await fetch(
      `https://web-production-e7a3.up.railway.app/withdrawal-list/${user.user.pk}`,
      {
        method: "GET",
    ...
    <div className="wrapper">
      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <strong class="logout" onClick={logoutUser}>
              Logout{" "}
            </strong>
          </li>
        </ul>
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <a onClick={home} class="brand-link">
          <img
            ...
            alt="AdminLTE Logo"
            class="brand-image img-circle elevation-3 admin-image"
          />
