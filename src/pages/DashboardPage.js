...
const DashboardPage = () => {
  ...
  let ListProperty = async (e) => {
    ...
    let response = await fetch("https://api.gamkrib.com/listings-create/", {
      method: "POST",
  ...
  const uploadImage = async (e) => {
    ...
    const response = await fetch(
      `https://api.cloudinary.com/v1_1/dmdf71t0f/image/upload`,
      {
        method: "POST",
  ...
  const getListedProperties = async () => {
    const response = await fetch(
      `https://api.gamkrib.com/my-listings/${user.user.pk}`,
  ...
  const getBookedProperties = async () => {
    const response = await fetch(
      `https://api.gamkrib.com/my-bookings/${user.user.pk}`,
    ...
    const response = await fetch(
      `https://api.paystack.co/bank?currency=GHS&type=mobile_money`,
      {
        ...
        headers: {
          "Content-Type": "application/json",
          Authorization:
            "Bearer pk_test_0019a4e3acb7a9886c8c65386a5be0619de6223e",
        },
      }
    );
  ...
  const Receipient = async () => {
    const response = await fetch(`https://api.paystack.co/transferrecipient`, {
      ...
      headers: {
        "Content-Type": "application/json",
        Authorization:
          "Bearer sk_test_ff6da6f1a15dbc14e2eb995db694bb824e3679c2",
      },
  ...
  const createWithdrawal = async () => {
    const response = await fetch(`https://api.gamkrib.com/withdrawal/`, {
      method: "POST",
  ...
  const getWithdrawals = async () => {
    const response = await fetch(
      `https://api.gamkrib.com/withdrawal-list/${user.user.pk}`,
      {
        method: "GET",
    ...
    <div className="wrapper">
      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
          ...
          <li class="nav-item cursor d-none d-sm-inline-block">
            <a onClick={home} class="nav-link">
              <b> Home</b>
            </a>
          </li>
        </ul>
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <strong class="logout cursor" onClick={logoutUser}>
              Logout{" "}
            </strong>
          </li>
        </ul>
      ...
      <aside class="main-sidebar brandColor elevation-4">
        <a onClick={home} class="brand-link">
          ...
          <b class="brand-text cursor">Gamkrib</b>
        </a>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-6">
                <div class="small-box bg-success">
                  ...
                  >
                    Withdrawal History <i class="fas fa-arrow-circle-right"></i>
                  </a>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-6">
                <div class="small-box bg-warning">
                  ...
                  <a class="small-box-footer" onClick={handleShow_Withdraw}>
                    Request Withdrawal <i class="fas fa-arrow-circle-right"></i>
                  </a>
                </div>
              </div>
            </div>
  ...
  */}
        ...
        <Modal
          show={showWhithdrawalHistory}
          onHide={handleWithdrawalHistoryClose}
        >
