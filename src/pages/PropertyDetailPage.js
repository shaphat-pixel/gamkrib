...
<div class="row hey">
<div class="col-sm "><div className='property-card'><img class="property-image" src={`${propertyDetail.image}`} width="305px" height="315px"/><span><GoLocation /> {propertyDetail.location}</span><p><BsFillPeopleFill/> {propertyDetail.number_of_persons} in a room</p><strong><ImPriceTags /> GHS {propertyDetail.price}</strong></div></div>
  <div class="col-sm "><div className='property-card'><img class="property-image" src={`${propertyDetail.image}`} width="305px" height="315px"/><span><GoLocation /> {propertyDetail.location}</span><p><BsFillPeopleFill/> {propertyDetail.number_of_persons} in a room</p><strong><ImPriceTags /> GHS {propertyDetail.price}</strong></div></div>
  <div class="col-sm "><div className='property-card'><img class="property-image" src={`${propertyDetail.image}`} width="305px" height="315px"/><span><GoLocation /> {propertyDetail.location}</span><p><BsFillPeopleFill/> {propertyDetail.number_of_persons} in a room</p><strong><ImPriceTags /> GHS {propertyDetail.price}</strong></div></div>
  
</div> <hr/><br/>
<div class="row">
  <div class="col-sm-6"><h2 class="align-items-center">Description and Reviews</h2></div>
  <div class="col-sm-6">
              ...
              <div class="d-flex flex-row pb-3">
                <div class="rounded border border-primary border-2 d-flex w-100 p-3 align-items-center checkout"
                  ...
                  <div class="d-flex flex-column">
                    <p class="mb-1 small text-primary">Amount to pay</p>
                    <h6 class="mb-0 text-primary">{propertyDetail.price}</h6>
                  </div>
                </div>
              </div>
