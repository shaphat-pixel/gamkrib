...
const ProfilePage = () => {
  ...
  const getBookings = async () => {
    const response = await fetch(
      `https://api.gamkrib.com/my-bookings-tenant/${user.user.pk}`,
      {
        method: "GET",
        credentials: "include",
        headers: {
  ...
  const setCheckedin = async () => {
    const response = await fetch(
      `https://api.gamkrib.com/my-bookings-tenant-update/${bookingId}`,
      {
        method: "PUT",
        credentials: "include",
        headers: {
            ...
            <div class="container-fluid">
              <div class="row">
                <section class="col-lg-7 connectedSortable">
                  ...
                  <p>
                    &nbsp;&nbsp;You can use the link provided to view the
                    location of your room.
                  </p>
                  <p>
                    &nbsp;&nbsp;After getting physical access to the room,
                    kindly click/tap on <strong>checked in</strong> to finalize
                  </p>
                  <p>
                    &nbsp;&nbsp; <strong></strong>
                  </p>
