...
import landingSmall from "../../asserts/images/smaller-screen-bg.webp";
  ...
  return (
    <div>
      <div className="d-flex  row mb-5">
        ...
        <div className="col-12  margin-right margin-left padding-right d-none d-md-block padding-left mt-2 ">
        ...
        {/* For smaller screens and medium */}
        <div className="col-12  margin-right margin-left padding-right d-md-none   d-sm-block padding-left mt-2 ">
          <img src={landingSmall} width="100%" className="" />
          <div className="textClass text-center row">
            <di>
        ...
        <div className="the-best py-5  container-fluid  text-center justify-content-center  mt-5">
          <p>
            <b>Expect the Best</b>
          </p>
          <div className="my-5 row d-flex container-fluid  justify-content-center align-items-space-around  justify-content-around gab-3">
